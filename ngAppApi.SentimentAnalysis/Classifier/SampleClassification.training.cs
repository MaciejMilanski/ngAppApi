...
namespace ngAppApi.Classifier.SampleClassification
{
    public partial class SampleClassification
    {
        public const string RetrainFilePath = @"C:\Users\masak\Downloads\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName: @"col0", outputColumnName: @"col0")
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options() { L1Regularization = 0.14169352F, L2Regularization = 0.03125F, LabelColumnName = @"col1", FeatureColumnName = @"Features" }))
